Prateek's Chilli Products - Static Website (GitHub Pages)
--------------------------------------------------------
...
1) Create a new repository on GitHub (for example: prateek-chilli-site).
2) On your local machine:
   git clone https://github.com/YOUR_USERNAME/prateek-chilli-site.git
   cp -r /path/to/unzipped/site/* prateek-chilli-site/
   cd prateek-chilli-site
   git add .
...
3) On GitHub, go to repository -> Settings -> Pages:
   - Select branch: main
   - Folder: / (root)
   - Save. The site will be published at https://YOUR_USERNAME.github.io/prateek-chilli-site/
...
- Create CNAME file containing your domain (e.g. prateekchilli.com)
